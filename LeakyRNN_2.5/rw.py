...
# def plot_Out(Net, Batch_Seq, Vectorrep=default_Vector,column=5, colorset=default_colorset, fig_length=10, add_P=None):
#     if Batch_Seq == []:
...
#         Vector=np.array(Vectorrep)
#         colorset=list(colorset)
#         Net.training=False
#         Input=Batch_Seq2Input(Batch_Seq,Vectorrep,P,type='reproduct',add_P=add_P)
#         hidden,out=Net(Input)
