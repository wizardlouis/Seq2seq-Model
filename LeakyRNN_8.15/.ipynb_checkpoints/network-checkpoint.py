...
class myRNN(nn.Module):
    ...
    def forward(self,hidden_0,Seq):
        ...
        for frame_input in Input:
            hidden=(1-self.d)*hidden+self.d*(self.W@self.act_func(hidden)+frame_input)
    ...
    def getDelay(self,trial,tolerate=30):
    ...
    def getTarget(self,trial,n_item):
        return torch.cat([trial[-self.t_retrieve+self.t_cue+i*(self.t_on+self.t_off):
