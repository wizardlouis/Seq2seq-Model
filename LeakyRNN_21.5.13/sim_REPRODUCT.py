...
P = dict(N_rank=args.N_rank, train_io=bool(args.train_io), train_hidden_0=bool(args.train_hidden_0), act_func=args.act_func,
...
for epoch in range(args.n_epochs):
    ...
    # error will occur when len(trainset)=1
    else:
        mixed_trainset = trainset
    Btl, Bl_ar, Bl_r, Bl_f, Bl_p = 0, 0, 0, 0, 0
    for Batch_seq in mixed_trainset:
        tl, l_ar, l_r, l_f, l_p = train(RNN, optimizer, scheduler, Batch_seq, default_Vector,
